...
func main() {
    ...
    go doGetRequest(url, respChan)//if not go routine it blocks since no reciever for unbuffered channel
                                 //at first the doGetRequest is a part of main function go routine
